...
export const Profile = () => {
  ...
  if (profileLoading) {
    return <div className="w-full h-[100dvh] flex justify-center items-center"><BeatLoader color="white" /></div>
  }
  ...
  return (
    <section id="profile" className="w-full">
      ...
      <div
        onClick={handleClose}
        className={`fixed z-50 top-0 left-0 flex justify-center items-center w-screen h-[100dvh] bg-[#FFFFFF20] ${
          open ? "block" : "hidden"
        }`}
      >
        <form
